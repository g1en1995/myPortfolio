...
import juggernaut from "../Juggernaut_Bitch.jpg";
...
export default function About(){
    ...
    return (
        <main className="relative">
            <img src={juggernaut} alt="juggernaut" className="absolute w-full"/>
                ...
                <section className="bg-red-800 rounded-lg shadow-2xl lg:flex p-20">
                    ...
                    <div className="text-lg  flex flex-col justify-center">
                        ...
                        <div className="prose lg:prose-xl text-white">
                            <BlockContent  blocks = {author.bio} projectId="z08u1u8u" dataset ="production"/>
                        </div>
                    </div>
                </section>
            </div>
